        ...
        <div>
            ...
            <div className="container mx-auto px-6 py-16 max-w-5xl">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {features.map((f, i) => (
                        <div key={i} className="bg-white rounded-2xl shadow-md p-8 text-center hover:shadow-xl transition-all border border-gray-100 animate-fade-in-up" style={{ animationDelay: `${i * 0.1}s` }}>
            ...
            <div className="bg-gradient-to-br from-slate-100 to-blue-50 py-14">
                <div className="container mx-auto px-6 max-w-4xl">
                    <h2 className="text-2xl font-extrabold text-center text-gray-800 mb-8">Villes desservies</h2>
