...
function App() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case "itineraires": return <Itineraires />;
    ...
    <div className="app-layout">
      <aside className="sidebar">
        ...
        <nav>
          ...
          <button className={page === "villes"      ? "active" : ""} onClick={() => setPage("villes")}>🏙️ Villes</button>
          <button className={page === "trains"      ? "active" : ""} onClick={() => setPage("trains")}>🚄 Trains</button>
          <button className={page === "segments"    ? "active" : ""} onClick={() => setPage("segments")}>🛤️ Segments</button>
          <button className={page === "itineraires" ? "active" : ""} onClick={() => setPage("itineraires")}>🗺️ Itinéraires</button>
          <button className={page === "historique"  ? "active" : ""} onClick={() => setPage("historique")}>📋 Historique</button>
